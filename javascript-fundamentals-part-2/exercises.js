...
const billsCE8 = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52];
const tipsCE8 = [];
const totalsCE8 = [];

for (let i = 0; i < billsCE8.length; i++) {
  const tip = calcTip(billsCE8[i]);
  tipsCE8.push(tip);
  totalsCE8.push(tip + billsCE8[i]);
}
console.log(billsCE8, tipsCE8, totalsCE8);

const calcAverageCE8 = function (arr) {
  let sum = 0;
...
console.log(`Tips: ${calcAverageCE8(tipsCE8)}`);
console.log(`Bills: ${calcAverageCE8(billsCE8)}`);
console.log(`Totals: ${calcAverageCE8(totalsCE8)}`);